 ...
 *
 * Modified by David Francisco (dmfranc.com)
 */
var htmlSlides = {
  ...
  init: function(options) {
    ...
    var $toolbar = $('#toolbar');
    var $nav = $('nav');
    var slideNumberColor  = $nav.css('color');
    var slideNumberShadow = $nav.css('text-shadow');

    $toolbar.addClass('toolbar-background');
    $nav.css('color', 'white');
    $nav.css('text-shadow', '0px 1px 0px black');
    ...
    function toggleBgd(visibility) {
      if ($toolbar.hasClass('hide-background')) {
        ...
        case "show":
          $toolbar.addClass('toolbar-background');
          $toolbar.removeClass('toolbar-background-hidden');

          slideNumberColor  = $nav.css('color');
          slideNumberShadow = $nav.css('text-shadow');
          $nav.css('color', 'white');
          $nav.css('text-shadow', '0px 1px 0px black');
          break;
        case "hide":
          $toolbar.removeClass('toolbar-background');
          $toolbar.addClass('toolbar-background-hidden');
          $nav.css('color', slideNumberColor);
          $nav.css('text-shadow', slideNumberShadow);
        }
      }
    }
  ...
  changeSlide: function(id) {
    ...
    $('nav').removeClass();
    $('nav').addClass('slide'+id); // Specific
